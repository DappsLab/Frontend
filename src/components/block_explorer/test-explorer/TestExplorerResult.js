    ...
    testTransactionByHash = (hash) => {
        ...
        client.query({
            query: gql`
                ...
                {
                    testTransactionByTransactionHash(transactionHash
                    :
                    $hash
                    )
                    {
    ...
    testByAddresses = (address) => {
        ...
        client.query({
            query: gql`
                ...
                {
                    testTransactionsByAddress(address
                    :
                    $address
                    )
                    {
    ...
    handleReturn() {
        ...
        if (!loading) {
            ...
            if (error === "" && data !== null) {
                ...
                if (search === "addresses") {
                    return <AddressesResult {...this.props} type={'test'} address={this.props.match.params.search}
                                            data={data}/>
                }
            } else {
                console.log("here")
                return <Grid textAlign={'center'}>
                    ...
                    <Grid.Row>
                        <Button onClick={() => {
                            this.props.history.push("/block_explorer")
                        }}><Link to={"/block_explorer"}>Goto Block Explorer</Link></Button>
                    </Grid.Row>
                </Grid>
            }
        }
